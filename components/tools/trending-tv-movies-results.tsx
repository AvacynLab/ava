...
const TrendingResults = ({ result, type }: TrendingResultsProps) => {
  // Si le prop result ou result.results n'est pas défini, on affiche un indicateur de chargement
  if (!result || !result.results) {
    return <div className="p-4 text-center">Loading trending data...</div>;
  }
