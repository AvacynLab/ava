...
export const LogoMistral = ({ size = 16 }: { size?: number }) => (
  <svg width={size} height={size} viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path
      d="M17.8816 3.29289C16.7195 2.13076 14.8485 2.13076 13.6863 3.29289L3.29289 13.6863C2.13076 14.8485 2.13076 16.7195 3.29289 17.8816L13.6863 28.275C14.8485 29.4372 16.7195 29.4372 17.8816 28.275L28.275 17.8816C29.4372 16.7195 29.4372 14.8485 28.275 13.6863L17.8816 3.29289ZM15.7839 5.39052C15.7839 5.39052 15.7839 5.39052 15.7839 5.39052L26.1773 15.7839L15.7839 26.1773L5.39052 15.7839L15.7839 5.39052Z"
      fill="currentColor"
    />
  </svg>
)
...
export const LogoDeepseek = ({ size = 16 }: { size?: number }) => (
  <svg width={size} height={size} viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path
      d="M16 2C8.268 2 2 8.268 2 16s6.268 14 14 14 14-6.268 14-14S23.732 2 16 2zm0 25.2c-6.182 0-11.2-5.018-11.2-11.2S9.818 4.8 16 4.8 27.2 9.818 27.2 16 22.182 27.2 16 27.2zm0-19.6c-4.636 0-8.4 3.764-8.4 8.4s3.764 8.4 8.4 8.4 8.4-3.764 8.4-8.4-3.764-8.4-8.4-8.4zm0 14c-3.09 0-5.6-2.51-5.6-5.6s2.51-5.6 5.6-5.6 5.6 2.51 5.6 5.6-2.51 5.6-5.6 5.6z"
      fill="currentColor"
    />
  </svg>
)

export const LogoCerebras = ({ size = 16 }: { size?: number }) => (
  <svg width={size} height={size} viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path
      d="M16 2C8.268 2 2 8.268 2 16s6.268 14 14 14 14-6.268 14-14S23.732 2 16 2zm0 26c-6.627 0-12-5.373-12-12S9.373 4 16 4s12 5.373 12 12-5.373 12-12 12zm-6-12c0-3.314 2.686-6 6-6s6 2.686 6 6-2.686 6-6 6-6-2.686-6-6z"
      fill="currentColor"
    />
  </svg>
)

// Mise à jour des logos existants pour Google et Anthropic

export const LogoGoogle = ({ size = 16 }: { size?: number }) => (
  <svg width={size} height={size} viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path
      d="M29.7 16.2c0-.9-.1-1.8-.3-2.7H16.3v5.1h7.5c-.3 1.7-1.3 3.2-2.8 4.2v3.5h4.5c2.6-2.4 4.2-6 4.2-10.1z"
      fill="#4285F4"
    />
    <path
      d="M16.3 30c3.8 0 7-1.3 9.3-3.5l-4.5-3.5c-1.3.9-2.9 1.4-4.8 1.4-3.7 0-6.8-2.5-7.9-5.8H3.8v3.6C6 26.8 10.8 30 16.3 30z"
      fill="#34A853"
    />
    <path
      d="M8.4 18.6c-.3-.9-.4-1.8-.4-2.8 0-.9.2-1.8.4-2.7V9.5H3.8C2.7 11.5 2 13.9 2 16.3s.7 4.8 1.8 6.8l4.6-3.6z"
      fill="#FBBC05"
    />
    <path
      d="M16.3 7.8c2.1 0 4 .7 5.5 2.1l4-4C23.4 3.7 20.1 2 16.3 2 10.8 2 6 5.2 3.8 9.8l4.6 3.6c1.1-3.3 4.2-5.6 7.9-5.6z"
      fill="#EA4335"
    />
  </svg>
)
...
export const LogoAnthropic = ({ size = 16 }: { size?: number }) => (
  <svg width={size} height={size} viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path
      d="M22.6667 0H17.4667L28.5333 32H33.7333L22.6667 0Z M8.53333 0L0 32H5.13333L7.06667 26.8667H18.9333L20.8667 32H26L17.4667 0H8.53333Z M8.13333 22.4L13.3333 8.53333L18.5333 22.4H8.13333Z"
      fill="currentColor"
    />
  </svg>
)
